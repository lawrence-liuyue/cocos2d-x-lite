...
{
    //#3 cc::pipeline::ForwardPipeline: is_skip_construtor True
    se::ScriptEngine::getInstance()->evalString("throw new Error(\"cc::pipeline::ForwardPipeline constructor is skipped\")");
    return false;
}
...
{
    //#3 cc::pipeline::DeferredPipeline: is_skip_construtor True
    se::ScriptEngine::getInstance()->evalString("throw new Error(\"cc::pipeline::DeferredPipeline constructor is skipped\")");
    return false;
}
